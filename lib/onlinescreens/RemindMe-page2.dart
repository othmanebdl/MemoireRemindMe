...
import 'package:testgoogle/onlinescreens/Controlle-scrollviewAll.dart';
import 'package:testgoogle/onlinescreens/controlle_scroll_viewToday.dart';
import 'package:testgoogle/onlinescreens/controlle_scroll_viexExam.dart';

import 'package:testgoogle/onlinescreens/controlle_scroll_viewHomework.dart';
import 'package:testgoogle/onlinescreens/controlle_scroll_viewlesson.dart';
...
class _RemindMe2State extends State<RemindMe2> {
  ...
  //pour controller le scrolle des tache
                    ...
                    child: Row(
                      children: [
                        IconButton(
                            ...
                            onPressed: () {
                              //pour routorner a la page précedent.
                              Get.to(RemindMe1());
                            }),
                        SizedBox(width: 15),
                        if (typetask == 1) ...[
