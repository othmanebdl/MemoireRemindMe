...
Widget buildListViewLesson(ScrollController _scrollController) => StreamBuilder(
...
Widget buildBTTLesson(ScrollController _scrollController, bool backtoTop) => backtoTop
    ? Align(
...
Widget buildTextLesson(bool isLastIndex) => isLastIndex
    ? Align(
