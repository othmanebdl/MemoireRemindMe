...
Widget buildListViewHomework(ScrollController _scrollController) => StreamBuilder(
                          ...
                          IconButton(
                              ...
                              onPressed: () {
                                Get.offAll(EditLessonHomework(),
                                    arguments: [snapchot.data.docs[index].id,snapchot.data.docs[index].data()['title'],snapchot.data.docs[index].data()['jour'],snapchot.data.docs[index].data()['mois'],snapchot.data.docs[index].data()['year'],snapchot.data.docs[index].data()['hour'],snapchot.data.docs[index].data()['minute']]);
                              }),
                          Text(
...
Widget buildBTTHomework(ScrollController _scrollController, bool backtoTop) => backtoTop
    ? Align(
...
Widget buildTextHomework(bool isLastIndex) => isLastIndex
    ? Align(
